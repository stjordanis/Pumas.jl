...
@test m.θ[1] ≈ 1.72E+00 rtol=0.05
@test m.θ[2] ≈ 8.57E-02 rtol=0.05
@test m.θ[3] ≈ 3.90E-02 rtol=0.05
@test m.θ[4] ≈ 1.73E+00 rtol=0.05
@test m.θ[5] ≈ 4.32E-01 rtol=0.05
@test_broken m.Ω[1] ≈ 1.09E+00 rtol=0.05
@test m.σ ≈ 1.24E+00 rtol=0.05

s = PuMaS.param_std(b)
@test s.θ[1] ≈ 4.62E-01 rtol=0.2
@test s.θ[2] ≈ 6.92E-03 rtol=0.05
@test s.θ[3] ≈ 2.16E-03 rtol=0.05
@test s.θ[4] ≈ 4.74E-01 rtol=0.1
@test s.θ[5] ≈ 1.54E-01 rtol=0.05
@test_broken s.Ω[1] ≈ 7.00E-01 rtol=0.05
@test s.σ ≈  1.68E-01 rtol=0.05
