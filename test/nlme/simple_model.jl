...
println([iwres(mdsl1,data[i],x0) for i in 1:10])
println([icwres(mdsl1,data[i],x0) for i in 1:10])
println([icwresi(mdsl1,data[i],x0) for i in 1:10])
println([inpde(mdsl1,data[i],x0,10000) for i in 1:10])