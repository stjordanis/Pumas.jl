...
sol, col = solve(m_diffeq, subject, x0, y0; tspan=(0.0,12.0+1e-14), abstol=1e-14, reltol=1e-14)
...
sol, col = solve(m_diffeq, subject, x0, y0; tspan=(0.0,60.0+1e-14), abstol=1e-14,reltol=1e-14)
