...
@test conditional_ll(mdsl,subject,x0,y0) ≈ conditional_ll(mobj,subject,x0,y0) rtol=5e-3
...
@test conditional_ll(mobj_iip,subject,x0,y0) ≈ conditional_ll(mobj,subject,x0,y0) rtol=5e-3
...
@test conditional_ll(mdsl,subject,x0,y0) == -Inf # since real-valued observations
