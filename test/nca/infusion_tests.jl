...
df.route = "inf"
data = @test_nowarn read_nca(df, id=:ID, time=:Time, conc=:Prefilter_Conc, warn=false, route=:route, amt=:Amount, duration=:Infusion_Time, timeu=timeu, concu=concu, amtu=amtu)
